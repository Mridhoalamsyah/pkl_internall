       ...
       <div class="row align-items-center">
          <div class="col-xl-7 col-lg-12 col-md-12 col-12">
             <div class="tp-breadcrumb">
                ...
                <h2 class="tp-breadcrumb__title">Shop Details V2</h2>
             </div>
          </div>
       </div>
    </div>
          ...
          <div class="col-lg-5 col-md-12">
             <div class="tpproduct-details__list-img">
                <div class="tpproduct-details__list-img-item">
                   <img src="assets/img/product/home-three/product-41.jpg" alt="">
                </div>
                <div class="tpproduct-details__list-img-item">
                   <img src="assets/img/product/home-three/product-42.jpg" alt="">
                </div>
                <div class="tpproduct-details__list-img-item">
                   <img src="assets/img/product/home-three/product-43.jpg" alt="">
                </div>
             </div>
          </div>
